#!/usr/bin/env python3
"""Manual smoke script for the Foresight game via APIClient."""
...
def main() -> None:
    """Start Foresight, print the opening turn, then take one action."""
    parser = argparse.ArgumentParser(description="Run a short Foresight session.")
