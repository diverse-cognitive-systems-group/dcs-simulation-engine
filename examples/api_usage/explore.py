#!/usr/bin/env python3
"""Manual smoke script for the Explore game via APIClient."""
...
def main() -> None:
    """Start Explore, print the opening turn, then take one action."""
    parser = argparse.ArgumentParser(description="Run a short Explore session.")
