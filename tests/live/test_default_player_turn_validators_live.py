"""Live OpenRouter smoke tests for default player-turn validator cases."""
...
async def test_default_player_turn_validators_live(case: dict[str, Any]) -> None:
    """Run the real default player-turn validator ensemble against each fixture case."""
