"""Live OpenRouter smoke tests for simulator-turn validator cases."""
...
async def test_simulator_turn_validators_live(case: dict[str, Any]) -> None:
    """Run the real simulator-turn validator ensemble against each fixture case."""
