...
Users can run games locally, deploy them for live participants (human via the GUI or AI via the API), extend the system with custom characters and games, and collect structured results.